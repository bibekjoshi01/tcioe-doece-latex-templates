...
\item \textbf{Graphics Processing Unit (GPU with CUDA Support)}
...
\item \textbf{Audio Input Device (Microphone)}
...
\item \textbf{Audio Output Device (Headphones or Speakers)}
...
\item \textbf{High-Performance Computing (HPC) / Cloud GPU Support}
